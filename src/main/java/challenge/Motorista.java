...
public class Motorista {
    ...
    public void validaCarteiraMotorista() {
        if (pontos > 20)
            throw new EstacionamentoException("O motorista não pode estar com a carteira suspensa (mais que 20 pontos).");    
    }
    ...
    public static class MotoristaBuilder {
        ...
        public Motorista build() {
            validaEntradaDeDados();
            if (idade < 18)
                throw new EstacionamentoException("O motorista não pode ter menos de 18 anos de idade.");
